...
const ViewApplications = () => {
  ...
  //Fucntion to fetch company jobs applications data
  ...
  //Fucntion to update job applications status
      ...
      <div>
        <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm '>
          <thead>
            ...
            <th className='py-2 px-4 text-left max-sm:hidden'>Loaction</th>
          ...
          <tbody>
            {applicants.filter(item => item.jobId && item.userId).map((applicant, index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b text-center max-sm:hidden'>{applicant.jobId.title}

                </td>
                <td className='py-2 px-4 border-b text-center max-sm:hidden'>{applicant.jobId.location}

                </td>
                <td className='py-2 px-4 border-b'>
                  <a className='bg-blue-50 px-3 text-blue-400 py-1 rounded inline-flex gap-2 items-center' href={applicant.userId.resume} target='_blank'>
