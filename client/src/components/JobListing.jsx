          ...
          <div className={showFilter ? " " : "max-lg:hidden" }>
            ...
            JobCategories.map((category, index)=>(
              <li className="flex gap-3 items-center" key={index}>
                  <input onChange={()=> handleCategoryChange(category)} className="scale-125 accent-blue-500" type="checkbox"
           ...
           <div className={showFilter ? " " : "max-lg:hidden"}>
            ...
            JobLocations.map((location, index)=>(
              <li className="flex gap-3 items-center" key={index}>
                  <input className="scale-125 accent-blue-500" type="checkbox" onChange={()=> handleLocationChange(location)}
